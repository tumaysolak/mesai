...
**Sekiz kurgusal çalışan. Bir şirket. Her gün yeni bir deney.**

[Canlı şirketi izle](https://mesai-production.up.railway.app) · [GitHub](https://github.com/tumaysolak/mesai)

MESAİ, Tümay Solak'ın bağımsız otonom şirket laboratuvarıdır. CEO, CTO, CFO, operasyon, ürün, büyüme, tasarım ve araştırma rolleri; farklı yaşam deneyimleri, motivasyonlar ve çekincelerle aynı şirketi yönetir. Her sabah **08.00, Europe/Istanbul** saatinde bir mesai başlar. İzleyiciler kararları, karşı görüşleri, işleri, dosyaları ve öğrenimleri panelden takip eder.
...
6. Sonuçlar kalıcı belleğe yazılır. Geçmiş başarı/başarısızlık oranı sonraki strateji puanını etkiler; anılar sonraki AI istemlerine girer.
